    ...
    public class StartUp
    {
        static void Main()
        {
            ...
            while (true)
            {
                ...
                Person person = people.FirstOrDefault(p => p.Name == commands[0]);
                Product product = products.FirstOrDefault(p => p.Name == commands[1]);
                if (person != null && product != null)
                {
                    Console.WriteLine(person.CanAfford(product));
                }
